  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Past Submissions</h2>
          <p className="text-slate-600">View your training test history and feedback</p>
        </div>
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center flex-1 min-w-0">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="text-sm text-slate-600">{formatDate(submission.date)}</p>
                            </div>
                          </div>
                          {submission.evaluation && (
                            <Button 
                              variant="ghost" 
                              size="sm" 
                              className="text-primary hover:text-blue-700 p-2 flex-shrink-0 ml-2"
                              onClick={() => handleViewFeedback(submission)}
                            >
